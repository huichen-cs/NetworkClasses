/* $Id: tcp_hello_srv.c,v d8130de1d3eb 2014-11-10 21:59:11Z hchen $ */
/* $HeadURL$ */
/*
 *	tcp_hello_srv.c
 */
/* Copyrignt 2014 Hui Chen, All Rights Reserved. */
static const char scmverid[] = "$Id: tcp_hello_srv.c,v d8130de1d3eb 2014-11-10 21:59:11Z hchen $";

/* Description */
/* 
 * A TCP'ed "hello, world"-kind of server program which dumps whatever it
 * recevies 
 */
...
{
	int srvfd = -1, clifd = -1, nrecv, quit = 0;
#if defined(_WIN32)
